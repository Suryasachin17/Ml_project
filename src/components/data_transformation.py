...
class dataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Categorical column standard scaling completed")
            ...
            logging.info("Numerical column preprocessor")

            logging.info("Categorical column preprocessor")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Obtained data completed ")
